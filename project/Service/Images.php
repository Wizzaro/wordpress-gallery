...
class Images extends AbstractSingleton {
    ...
    public function edit_post_image_data( $post, $img_id, $img_data ) {
        ...
        if ( is_array( $img_data ) ) {
            $data['alt_text'] = array_key_exists( 'alt_text', $img_data ) && is_string( $img_data['alt_text'] ) ? Filter::get_instance()->filter_text( $img_data['alt_text'] ) : null;
            ImagesDBTable::get_instance()->save_image_data( $image->ID, $data );
        }
